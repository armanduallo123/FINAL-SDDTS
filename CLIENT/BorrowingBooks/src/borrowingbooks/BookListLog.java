...
public class BookListLog extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 170, 90, -1));
        ...
        jPanel1.add(book_number_field, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 170, 180, 30));
        ...
        jPanel1.add(book_author_field, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 130, 200, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {   
            // Create the SQL query with placeholders
            String insertQuery = "INSERT INTO listofbooks(Book_Name,Book_Number,Book_Author) VALUE (?,?,?)";
            ...
            statement.setString(2, book_number_field.getText());
             statement.setString(3, book_author_field.getText());
            statement.executeUpdate();

            this.book_name_field.setText("");
            this.book_number_field.setText("");
            this.book_author_field.setText("");
    ...
    book_number_field.setText(RecordTable.getValueAt(SelectedRows, 2).toString());
    book_author_field.setText(RecordTable.getValueAt(SelectedRows, 3).toString());
    }//GEN-LAST:event_jTable1MouseClicked

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
          try {
            // Create the SQL query with placeholders
            String searchQuery = "SELECT * FROM listofbooks WHERE Book_id LIKE ? OR Book_Name LIKE ? OR Book_Number LIKE ? OR Book_Author LIKE ? ";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      String AvailableBooks = book_number_field.getText();
      String BookAuthor = book_author_field.getText();
      
      String updateQuery = "UPDATE listofbooks SET Book_Name = ?, Book_Number = ?, Book_Author = ? WHERE Book_id = ?";
 try {
